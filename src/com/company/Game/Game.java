...
public class Game extends Canvas implements Runnable {
    ...
    private void init() throws IOException {
        ...
        backgroundmenu=ImageIO.read(getClass().getResource("/backgroundmenu.png"));

        background1=ImageIO.read(getClass().getResource("/background.png"));
        background2=ImageIO.read(getClass().getResource("/park.jpg"));
        victory=ImageIO.read(getClass().getResource("/victory.jpg"));
